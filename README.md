# PITB Internship Project — Virtual Try-On

Internship project repository for **Mohsin Raza Aujla** (PITB).

See [WORK_REPORT.md](WORK_REPORT.md) for the full work report (timeline, what was
built, and how it was tested).

## Contents

- **[virtual-tryon/](virtual-tryon/)** — the deliverable: a CLI tool that lets a
